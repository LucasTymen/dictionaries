...
Because zip() returns an iterator, it is necessary to use the list() function, or a similar function like tuple() or
...
If one of the iterators passed in as a parameter to zip() contains more objects than another, then the extra objects
will be ignored:
"""
